            ...
            <div class="mini-cart-total d-flex justify-content-between py-4">
              ...
              <span class="special-price-code">
                <span class="price-amount amount fs-6" style="opacity: 1;">
                  <bdi>
                    <span class="price-currency-symbol">$</span>99.00 </bdi>
                </span>
              </span>
            </div>
      ...
      <div class="modal-body">
        <div class="login-detail">
              ...
              <form id="login-form">
                ...
                <div class="checkbox d-flex justify-content-between mt-4">
                  <p class="checkbox-form">
                    <label class="">
                      <input name="remember" type="checkbox" id="remember-me" value="forever"> Remember me </label>
                  </p>
          ...
          <div class="modal-footer mt-5 d-flex justify-content-center">
            <button type="button" class="btn btn-red hvr-sweep-to-right dark-sweep" data-bs-dismiss="modal">Login</button>
            <button type="button" class="btn btn-outline-gray hvr-sweep-to-right dark-sweep" data-bs-dismiss="modal">Register</button>
          </div>
        </div>
      </div>
    </div>
