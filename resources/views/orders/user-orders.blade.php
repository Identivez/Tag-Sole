                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    @if($orders->isEmpty())
                        <div class="text-center py-8">
                            <p class="text-gray-500 mb-4">No tienes pedidos realizados aún.</p>
                                    ...
                                    @foreach($orders as $order)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <a href="{{ route('orders.confirmation', $order->OrderId) }}" class="text-indigo-600 hover:text-indigo-900 mr-3">
                                                    Ver detalles
                                                </a>

                                                @if($order->OrderStatus == 'Pendiente')
                                                    <form action="{{ route('orders.cancel', $order->OrderId) }}" method="POST" class="inline">
                                                        @csrf
