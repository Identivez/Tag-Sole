    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <!-- Cart Icon -->
                <div class="ml-4">
                    <a href="{{ route('cart.view') }}" class="inline-flex items-center text-gray-500 hover:text-gray-700">
                        ...
                        @auth
                            ...
                            @endphp
                            @if($cartCount > 0)
                                <span class="ml-1 bg-red-500 text-white px-2 py-0.5 rounded-full text-xs">{{ $cartCount }}</span>
                            @endif
                        @endauth
                    </a>
                </div>
        ...
        @auth
            <div class="pt-4 pb-1 border-t border-gray-200">
                ...
                <div class="mt-3 space-y-1">
                    ...
                    <x-responsive-nav-link :href="route('user.orders')">
                        {{ __('Mis pedidos') }}
                    </x-responsive-nav-link>
